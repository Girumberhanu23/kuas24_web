...
import type { FixtureTeamStatistics } from "../../../../lib/types";

type ApiSportsFixtureStatisticsResponse = {
  results: number;
...
export async function GET(
  ...
  const upstream = new URL("/fixtures/statistics", baseUrl);
  ...
  const data = (await res.json()) as ApiSportsFixtureStatisticsResponse;
